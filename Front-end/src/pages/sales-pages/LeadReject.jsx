...
import toast from "react-hot-toast"; // Integrated for feedback
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded shadow w-full sm:w-auto flex items-center justify-center gap-2"
          >
            Download
          </button>
        </div>
