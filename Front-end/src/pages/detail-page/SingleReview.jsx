      ...
      <div className="flex-1 md:ml-64 p-4 md:p-6 overflow-y-auto">
        ...
        <div className="text-black rounded-xl p-4 md:p-6 mb-4 shadow-lg flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 mt-2 md:mt-0">
            {dataDetail.files.map((file, idx) => (
              <a
                key={idx}
                href={file.url}
                download
                className="flex items-center gap-2 px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-xs sm:text-sm"
              >
                <Download size={16} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          ...
          <div className="bg-white p-4 rounded-xl shadow hover:shadow-lg transition">
            ...
            <p className="text-xl font-bold mt-2">{dataDetail.submittedDate}</p>
          </div>
        </div>
