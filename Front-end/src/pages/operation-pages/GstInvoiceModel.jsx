        ...
        >
          <div style={{ flex: 1 }}>
            ...
            <table className="items-table" style={{ width: '100%', borderCollapse: 'collapse', marginTop: '20px', border: '1px solid #000' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #000' }}>
                  ...
                  <th style={{...cellStyle, width: '40%', borderRight: '1px solid #000'}}>DESCRIPTION</th>
                  <th style={{...cellStyle, borderRight: '1px solid #000'}}>QTY</th>
                  <th style={{...cellStyle, borderRight: '1px solid #000'}}>UNIT PRICE</th>
                  <th style={{...cellStyle, borderRight: '1px solid #000'}}>TAX</th>
                  <th style={{...cellStyle, borderRight: '1px solid #000'}}>KFC 1%</th>
                  <th style={{...cellStyle, borderRight: '1px solid #000'}}>TOTAL TAX</th>
              ...
              <tbody>
                {items.map((itm, index) => (
                  <tr key={index} style={{ borderBottom: '1px solid #000' }}>
                    ...
                    <td align="center" style={{...cellStyle, borderRight: '1px solid #000'}}>{itm.unitPrice > 0 ? "18%" : ""}</td>
                    <td style={{...cellStyle, borderRight: '1px solid #000'}}></td>
                    <td align="right" style={{...cellStyle, borderRight: '1px solid #000'}}>{itm.unitPrice > 0 ? fmt(itm.unitPrice * 0.18) : ""}</td>
                    <td align="right" style={cellStyle}>{itm.unitPrice > 0 ? fmt(itm.unitPrice * 1.18) : ""}</td>
                  </tr>
                ))}
                
                <tr style={{ borderBottom: '1px solid #000' }}>
                  <td style={{...cellStyle, borderRight: '1px solid #000'}}>4</td>
                  <td style={{...cellStyle, borderRight: '1px solid #000'}}><strong>Advance</strong></td>
                  <td colSpan="5" style={{...cellStyle, borderRight: '1px solid #000'}}></td>
                ...
                <tr style={{ borderBottom: '1px solid #000' }}>
                  <td style={{...cellStyle, borderRight: '1px solid #000'}}>5</td>
                ...
                <tr style={{background: '#f9f9f9', fontWeight: 'bold'}}>
                  <td colSpan="6" align="right" style={{...cellStyle, borderRight: '1px solid #000'}}>Total</td>
                  <td align="right" style={{...cellStyle, borderRight: '1px solid #000'}}>{fmt(totalTax)}</td>
            ...
            <div className="summary-container" style={{ display: 'flex', justifyContent: 'space-between', marginTop: '20px' }}>
              <table className="tax-summary-table" style={{ border: '1px solid #000', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ background: '#f5f5f5', borderBottom: '1px solid #000' }}>
                    <th style={{ padding: '4px', borderRight: '1px solid #000' }}>Tax</th>
                    <th style={{ padding: '4px', borderRight: '1px solid #000' }}>Rate</th>
                    <th style={{ padding: '4px' }}>Amount</th>
                  </tr>
                </thead>
                <tbody>
                  <tr style={{borderBottom: '1px solid #eee'}}><td style={{ padding: '4px', borderRight: '1px solid #000' }}>CGST</td><td style={{ padding: '4px', borderRight: '1px solid #000' }}>9%</td><td align="right" style={{ padding: '4px' }}>{fmt(totalTax/2)}</td></tr>
                  <tr style={{borderBottom: '1px solid #eee'}}><td style={{ padding: '4px', borderRight: '1px solid #000' }}>SGST</td><td style={{ padding: '4px', borderRight: '1px solid #000' }}>9%</td><td align="right" style={{ padding: '4px' }}>{fmt(totalTax/2)}</td></tr>
                  <tr style={{borderBottom: '1px solid #eee'}}><td style={{ padding: '4px', borderRight: '1px solid #000' }}>KFC</td><td style={{ padding: '4px', borderRight: '1px solid #000' }}>1%</td><td align="right" style={{ padding: '4px' }}>0.00</td></tr>
                  <tr style={{fontWeight:'bold', borderTop: '1px solid #000'}}>
                    <td style={{ padding: '4px', borderRight: '1px solid #000' }}>Total</td>
                    <td style={{ padding: '4px', borderRight: '1px solid #000' }}></td>
                    <td align="right" style={{ padding: '4px' }}>{fmt(totalTax)}</td>
                  </tr>
                </tbody>
              </table>
